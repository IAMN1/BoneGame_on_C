...
Если вы перенесёте её на SDL2, raylib, WebAssembly или что угодно ещё — заводите issue, и ссылка
появится прямо здесь. Порты — единственный вклад, которого этот репозиторий ждёт; код 2017 года
остаётся нетронутым вместе со всеми багами. Исправления документации и переводы тоже
приветствуются — что в скоупе, а что нет, написано в
